...
const Holiday = () => {
  ...
  const destinations = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1599661046289-e31897846e41?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80",
      days: 7,
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1602216056096-3b40cc0c9944?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80",
      days: 6,
      meals: "All Meals",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1626621341517-bbf3d9990a23?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80",
      days: 8,
      meals: "Breakfast",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1512343879784-a960bf40e7f2?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80",
      days: 4,
      meals: "Breakfast",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1519677100203-a0e668c92439?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80",
      days: 6,
      meals: "All Meals",
      activities: "12+ Activities",
      price: 42999,
  ...
  const themes = [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1547970810-dc1eac37d174?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80",
    },
    {
      id: 4,
      name: "Heritage Tours",
      image:
        "https://images.unsplash.com/photo-1524492412937-b28074a5d7da?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80",
    },
    {
      id: 5,
      name: "Honeymoon Packages",
      image:
        "https://images.unsplash.com/photo-1544161515-4ab6ce6db874?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80",
    },
  ];
  ...
  const testimonials = [
    {
      id: 1,
      content:
        "Our trip to Rajasthan was absolutely magical! The palaces, the culture, the food - everything was perfect. The tour was well organized and our guide was knowledgeable and friendly.",
      author: "Priya Sharma",
      avatar:
    ...
    },
    {
      id: 2,
      content:
        "Kerala backwaters cruise was the highlight of our trip. Staying in a houseboat and waking up to serene views was an experience we'll never forget. Highly recommend!",
      author: "Rahul Mehta",
      avatar:
    ...
    },
    {
      id: 3,
      content:
        "The Himalayan Adventure package exceeded our expectations. The views were breathtaking and the activities were thrilling. Perfect balance of adventure and relaxation.",
      author: "Ananya Patel",
      avatar:
    ...
    <div className={styles.holidayPage}>
      <div className={styles.banner}>
        ...
        <div className={styles.bannerContent}>
          ...
          <p className={styles.bannerSubtitle}>
            Explore the diverse landscapes, rich culture, and unforgettable
      ...
      <section>
        ...
        <p className={styles.sectionSubtitle}>
          Discover our most loved holiday packages across India. From royal
          Rajasthan to serene Kerala backwaters, adventurous Himalayas to exotic
          beaches - we have something for every traveler.
        </p>
      ...
      <section className={styles.ctaSection}>
        ...
        <p className={styles.ctaDescription}>
          Book your dream holiday today and get exclusive offers, personalized
